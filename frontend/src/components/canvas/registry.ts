...
import { CanvasButton, exportButtonTemplate, buttonSchema } from '@/components/canvas/button'
...
import { CanvasImage, exportImageTemplate, imageSchema } from '@/components/canvas/image'
...
export const componentRegistry: Record<string, ComponentDefinition> = {
  button: { type: 'button', label: '按钮', Canvas: CanvasButton, exportTemplate: exportButtonTemplate, schema: buttonSchema },
  ...
  image: { type: 'image', label: '图片', Canvas: CanvasImage, exportTemplate: exportImageTemplate, schema: imageSchema },
}
